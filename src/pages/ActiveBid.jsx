...
function ActiveBid() {
  ...
  const filteredAuctions = allAuction.filter(
    (auction) =>
            ...
            <div className="flex justify-center items-center gap-70 w-full">
              ...
              >
                <motion.h1
                  ...
                  className="font-['Noto_Serif'] text-5xl md:text-7xl text-[#1c1b1b] leading-tight"
                >
                  Big wins start with
                </motion.h1>
                <motion.h1
                  variants={itemVariants}
                  className="font-['Noto_Serif'] text-5xl md:text-7xl bg-gradient-to-r from-[#570000] to-[#800000] bg-clip-text text-transparent leading-tight mb-6 text-center font-bold"
                >
                  A Little Bid
                </motion.h1>
                <motion.span
                  variants={itemVariants}
                  className="font-['Manrope'] uppercase tracking-[0.3em] bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-4 block text-xl font-bold"
                >
                ...
                <motion.div variants={itemVariants}>
                  <NavLink to="/products">
                    <p
                      className="font-headline md:text-lg text-white font-bold text-center mt-20 flex
              bg-red-950
               w-45 h-8 items-center align-middle justify-center rounded-2xl mx-auto hover:scale-110"
                    >
                      View Products
                    </p>
                  </NavLink>
