        ...
        <div>
            <section className="relative h-[80vh] min-h-[600px] flex items-center px-6 md:px-12 overflow-hidden">
                ...
                <div className='flex justify-between items-start gap-70 '>
                    ...
                    <p className="font-headline text-3xl md:text-8xl bg-gradient-to-r from-red to-purple bg-clip-text text-transparent leading-tight mb-8 ml-35">"{user.username}"</p>
                </div>
